 ...
 * the entry, as someone else might have used it which you slept.
 */
...
int sys_d_link(const char *oldname, const char *newname)
{
    struct dir_entry *de;
...
int debug_syscall_link0(void)
{
    d_link("/etc/rc", "/usr/bin/rc");
    return 0;
}
