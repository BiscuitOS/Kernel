/*
 * Interrupt 11: Segment Not Present (#NP) when moving FS
 *
...
/*
 * Trigger interrupt 11: MOV a selector that not marked present to FS
 ...
 *   
 *   IF FS is loadded with non-NULL selector
 *   THEN
