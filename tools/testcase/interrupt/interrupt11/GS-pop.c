/*
 * Interrupt 11: Segment Not Present (#NP) when poping GS
 *
...
/*
 * Trigger interrupt 11: POP a selector that not marked present to GS
 ...
 *   
 *   IF GS is loadded with non-NULL selector
 *   THEN
