/*
 * Interrupt 11: Segment Not Present (#NP) when moving DS
 *
...
/*
 * Trigger interrupt 11: MOV a selector that not marked present to DS
 ...
 *   
 *   IF DS is loadded with non-NULL selector
 *   THEN
