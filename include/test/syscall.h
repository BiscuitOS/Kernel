...
extern int debug_syscall_setgid_common_userland(void);
#ifdef CONFIG_DEBUG_SYSCALL_SETGID0
extern int debug_syscall_setgid0(void);
#endif
#endif // CONFIG_DEBUG_SYSCALL_SETPGID

#ifdef CONFIG_DEBUG_SYSCALL_SETREGID
extern int debug_syscall_setregid_common_userland(void);
#ifdef CONFIG_DEBUG_SYSCALL_SETREGID0
extern int debug_syscall_setregid0(void);
#endif
#endif // CONFIG_DEBUG_SYSCALL_SETREPGID

#ifdef CONFIG_DEBUG_SYSCALL_BRK
extern int debug_syscall_brk_common_userland(void);
#ifdef CONFIG_DEBUG_SYSCALL_BRK0
extern int debug_syscall_brk0(void);
#endif
...
extern int debug_syscall_break_common_userland(void);
#ifdef CONFIG_DEBUG_SYSCALL_BREAK0
extern int debug_syscall_break0(void);
#endif
