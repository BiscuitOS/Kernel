...
static inline int kbd_flag(int flag)
{
	return kbd_flags & (1 << flag);
}

static inline void set_kbd_flag(int flag)
{
	kbd_flags |= 1 << flag;
}

static inline void clr_kbd_flag(int flag)
{
	kbd_flags &= ~(1 << flag);
}

static inline void chg_kbd_flag(int flag)
{
	kbd_flags ^= 1 << flag;
}

static inline int vc_kbd_flag(struct kbd_struct * kbd, int flag)
{
	return ((kbd->flags >> flag) & 1);
}

static inline void set_vc_kbd_flag(struct kbd_struct * kbd, int flag)
{
	kbd->flags |= 1 << flag;
}

static inline void clr_vc_kbd_flag(struct kbd_struct * kbd, int flag)
{
	kbd->flags &= ~(1 << flag);
}

static inline void chg_vc_kbd_flag(struct kbd_struct * kbd, int flag)
{
	kbd->flags ^= 1 << flag;
}
