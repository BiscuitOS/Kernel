#ifndef _DEMO_DEBUG_H
#define _DEMO_DEBUG_H
...
/* userspace */
#define user0_debugcall(fn)             __define_debugcall(fn,8)
#define user0_debugcall_sync(fn)        __define_debugcall(fn,8s)
#define user1_debugcall(fn)             __define_debugcall(fn,9)
#define user1_debugcall_sync(fn)        __define_debugcall(fn,9s)
#define user2_debugcall(fn)             __define_debugcall(fn,a)
#define user2_debugcall_sync(fn)        __define_debugcall(fn,as)
